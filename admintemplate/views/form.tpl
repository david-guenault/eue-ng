%rebase layout globals(), title="Statistics", css=["bootstrap/css/bootstrap.min.css", "bootstrap/css/bootstrap-responsive.min.css", "assets/styles.css", "vendors/datepicker.css", "vendors/uniform.default.css", "vendors/chosen.min.css", "vendors/wysiwyg/bootstrap-wysihtml5.css"], js=["vendors/modernizr-2.6.2-respond-1.1.0.min.js"], jslate=["vendors/jquery-1.9.1.js", "bootstrap/js/bootstrap.min.js", "vendors/jquery.uniform.min.js", "vendors/chosen.jquery.min.js", "vendors/bootstrap-datepicker.js", "vendors/wysiwyg/wysihtml5-0.3.0.js", "vendors/wysiwyg/bootstrap-wysihtml5.js", "vendors/wizard/jquery.bootstrap.wizard.min.js", "assets/scripts.js", "js/form.js"]
                    ...
                    <form class="form-horizontal">
                      <fieldset>
                        ...
                        <div class="control-group">
                          ...
                          <div class="controls">
                            <input type="text" class="span6" id="typeahead"  data-provide="typeahead" data-items="4" data-source='[]'>
